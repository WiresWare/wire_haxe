...
class Main {
    static public function main() {
        ...
        trace('\n=============== SUBSCRIBER and API EXAMPLE ===============');
        Wire.add(SCOPE, SIGNAL_1, function(data:Dynamic, wid:Int):Void {
            trace('> SIGNAL 1 (subscriber 1) -> Hello: ' + data);
        });

        var listener1:WireListener = function(data:Dynamic, wid:Int) {
        ...
        /// REMOVE EXAMPLE ===========================================
        trace('\n=============== REMOVE EXAMPLE ===============');
        var listener2:WireListener = function(data:Dynamic, wid:Int) {
        ...
        /* 4 */ Wire.add(SCOPE_2, SIGNAL_4, function(data:Dynamic, wid:Int) { trace('> Remove: SIGNAL 2 -> data: ' + data); });
        ...
        Wire.add(SCOPE, SIGNAL_ONCE, function(data:Dynamic, wid:Int) {
        ...
        Wire.add(SCOPE, SIGNAL_2, function(data:Dynamic, wid:Int) {
